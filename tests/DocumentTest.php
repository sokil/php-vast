...
class DocumentTest extends AbstractTestCase
{
    ...
    /**
     * test for mediaFile url update
     */
    public function testMediaFileUrlUpdate()
    {
        $factory = new Factory();
        $document = $factory->create('2.0');
        ...
        // create creative for ad section
        /** @var \Sokil\Vast\Creative\InLine\Linear\MediaFile $mediaFile */
        $mediaFile = $ad1
            ->createLinearCreative()
            ->setDuration(128)
            ->setVideoClicksClickThrough('wrongLink')
        ...
        $mediaFile->setUrl('http://server.com/media.mp4');
        $this->assertFileVsDocument('inlineAd.xml', $document);
    }
    ...
    public function testFromFile()
    {
        ...
        self::assertEquals(
            ...
            $creative->getVideoClicksClickTracking()
        );
        self::assertEquals(
            array(
